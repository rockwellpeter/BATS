...
parser.add_argument("-opt", type=str, default="config/sisr/options/test/ours.yml", help="Path to options YMAL file.")
...
for test_loader in test_loaders:
    ...
    for i, test_data in enumerate(test_loader):
        ...
        model.test_visual(sde=sde,current_step=-1,name="epsilon-multistep-unrolled-prob-alpha")
        toc = time.time()
        ...
        if need_GT:
            ...
            sr_dir = 'temp_sr_unrolled_ori'
            gt_dir = 'temp_gt_unrolled_ori'
