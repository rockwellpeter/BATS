...
def main():
    ...
    parser.add_argument("-opt", type=str, default="config/denoising-sde/options/train/ours.yml",help="Path to option YMAL file.")
    parser.add_argument(
    ...
    if rank <= 0:  # normal training (rank -1) OR distributed training (rank 0-7)
        if resume_state is None:
            ...
            os.system("rm ./log_denosing")
            os.symlink(os.path.join(opt["path"]["experiments_root"], ".."), "./log_denosing")
        ...
        if opt["use_tb_logger"] and "debug" not in opt["name"]:
            ...
            tb_logger = SummaryWriter(log_dir="log_denosing/{}/tb_logger/".format(opt["name"]))
    else:
        util.setup_logger(
